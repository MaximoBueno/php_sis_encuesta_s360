...
function enviarEncuesta(){
    ...
    $.post("./procesos/guardarRespuesta.php", 
        {ce: mycevirable, ra: myravirable, te: mytevirable}, 
            function(mensaje) {
...
function mensajeEncuesta(mensaje){
    ...
    if(mensaje == "OK"){
        ...
        abrirModalOKI("Gracias por realizar la encuesta.", my_icono);
        reDireccionarOKI();
    }else if(mensaje == "NUL"){
        ...
        abrirModalOKI(mensaje, my_icono);
        miModalOkiClose();
    }
}
